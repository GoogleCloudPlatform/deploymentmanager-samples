# Interactive Deployment Manager Walkthrough
...
Begin your configuration by declaring the `resources` property, followed by the first virtual machine instance's type and name:
...
You have created a configuration file, which you can now use to create a deployment. Because Deployment Manager uses declarative code, you declare the resources you want in a file, and Deployment Manager creates the resources for you.

To learn how to deploy the resources in your configuration, continue to the next step. 
